...
OUT_DIR="$SCRIPT_DIR/../Migrations"  # src/Services/Basket/Basket.Api/Infrastructure/Data
PROJECT_PATH="$SCRIPT_DIR/../../../Basket.Api.csproj"
STARTUP_PROJECT_PATH="$SCRIPT_DIR/../../../../Basket.Api/Basket.Api.csproj"
