...
OUT_DIR="$SCRIPT_DIR/../Migrations"  # src/Services/Catalog/Catalog.Api/Infrastructure/Data
PROJECT_PATH="$SCRIPT_DIR/../../../Catalog.Api.csproj"
STARTUP_PROJECT_PATH="$SCRIPT_DIR/../../../../Catalog.Api/Catalog.Api.csproj"
