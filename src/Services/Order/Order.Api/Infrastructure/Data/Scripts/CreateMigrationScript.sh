...
OUT_DIR="$SCRIPT_DIR/../Migrations"  # src/Services/Order/Order.Api/Infrastructure/Data
PROJECT_PATH="$SCRIPT_DIR/../../../Order.Api.csproj"
STARTUP_PROJECT_PATH="$SCRIPT_DIR/../../../../Order.Api/Order.Api.csproj"
